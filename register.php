  ...
  <main>
    <section id="login">
      ...
      <form action="">
        ...
        <input type="email" name="user-email" id="user-email" placeholder="Correo">
        <input type="password" name="user-password" id="user-password" placeholder="Contraseña">
        <input type="password" name="confirm-password" id="confirm-password" placeholder="Confirmar contraseña">
